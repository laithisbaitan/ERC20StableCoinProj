...
import { DepositorCoin, DepositorCoin__factory, StableCoin } from "../typechain-types";
...
describe("StableCoin", function () {
  ...
  it("Should set fee rate percntage", async function(){
  ...
  describe("With minted tokens", function(){
    ...
    describe("With deposited collateral buffer", function(){
      ...
      it("Should allow withdrawing collateral buffer", async function(){
        const newDepositorTotalSupply = stableCoinCollateralBuffer *
        ethUsdPrice;
